...
build:
	...
	@ ocamlopt unix.cmxa ferrolexAst.ml ferrolex_var.ml ferrolex_utilities.mli ferrolex_utilities.ml ferrolexParser.mli ferrolexParser.ml ferrolexLexer.ml ferrolex.ml -o ferrolex -O3
...
build_timed:
	...
	time ocamlopt unix.cmxa ferrolexAst.ml ferrolex_var.ml ferrolex_utilities.mli ferrolex_utilities.ml ferrolexParser.mli ferrolexParser.ml ferrolexLexer.ml ferrolex.ml -o ferrolex -O3
